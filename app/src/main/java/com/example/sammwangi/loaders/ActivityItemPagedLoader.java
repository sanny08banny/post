...
public class ActivityItemPagedLoader extends AsyncTaskLoader<List<PostItem>> {
    private final int page;
    private final int pageSize;
    private List<PostItem> cachedData;
    private String baseUrl;

    public ActivityItemPagedLoader(Context context, int page, int pageSize) {
        super(context);
        this.page = page;
    ...
    public List<PostItem> loadInBackground() {
        try {
            ...
            Call<Page<PostItem>> call = service.getAllPostsPaged(page, pageSize);
