...
//                .into(holder.profileImage);
        ...
        if (account.getAccountType().equals("accountant")){
            holder.profileImage.setImageResource(R.drawable.untitled_design_7);
        }else{
            holder.profileImage.setImageResource(R.drawable.untitle_design_4);
        }
...
//                    v.getContext().startActivity(intent);
            ...
            private void deleteAccount(ProfileAccount profile) {
                ...
                boolean accountSavedLocally = dataBaseHelper.deleteProfile(profile);

                updateProfileAccounts(accounts);
