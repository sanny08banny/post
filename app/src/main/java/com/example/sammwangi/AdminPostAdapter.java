...
//        String formattedDate = simpleDateFormat.format(date2);
        ...
        AdminPostsAdapterInner adminPostsAdapterInner = new AdminPostsAdapterInner(notificationsItemList);
    ...
    public int getItemCount() {
        Log.e("NotificationsItemAdapter","Number of items: " + groupedPostList.size());
